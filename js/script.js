...
const showResult = (result, quiz) => {
    ...
    const button = document.createElement('button');
    button.className = 'main__btn result__returm';
...
const renderQuiz = quiz => {
    const quiztionBox = document.createElement('div');
    quiztionBox.className = 'main__box main__box_question';

    hideElem(title);
    hideElem(selection, () => {
        
        showElem(quiztionBox);
        main.append(quiztionBox);
    });
    ...
    const showQuestion = () => {
        ...
        const button = document.createElement('button');
        button.className = 'main__btn queestion__next';
        button.type = 'submit';
